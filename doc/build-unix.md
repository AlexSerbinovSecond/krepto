UNIX BUILD NOTES
====================
Some notes on how to build Krepto core in Unix.
...
memory available when compiling Krepto core. On systems with less, gcc can be
...
To build Krepto core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Krepto core can
