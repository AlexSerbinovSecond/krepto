...
Below are some notes on how to build Krepto core for Windows.

The options known to work for building Krepto core on Windows are:
...
Note that for WSL the Krepto core source path MUST be somewhere in the default mount file system, for
