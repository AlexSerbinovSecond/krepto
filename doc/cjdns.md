# CJDNS support in Krepto core

It is possible to run Krepto core over CJDNS, an encrypted IPv6 network that
...
done outside of Krepto core, similarly to a VPN (either in the host/OS or on
...
before it will work with your Krepto core node. This is described in steps
...
## Run Krepto core with CJDNS

Once you are connected to the CJDNS network, the following Krepto core
...
When enabled, this option tells Krepto core that it is running in an
...
IPv6 local network. This helps Krepto core perform better address management:
...
CJDNS support was added to Krepto core in version 23.0 and there may be fewer
...
## CJDNS-related information in Krepto core

There are several ways to see your CJDNS address in Krepto core:
