# Support for Output Descriptors in Krepto core

Since Krepto core v0.17, there is support for Output Descriptors. This is a
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Krepto core descriptor wallet to serve as your
...
existing Krepto core wallets, a convenience function `combo` is
...
All RPCs in Krepto core will include the checksum in their output. Only
