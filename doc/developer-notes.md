...
- [Development guidelines](#development-guidelines)
    - [General Krepto core](#general-bitcoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Krepto core uses [Doxygen](https://www.doxygen.nl/) to generate its official documentation.
...
Krepto core is a multi-threaded application, and deadlocks or other
...
Krepto core can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as Krepto core, where everyone uses
...
pay attention to for reviewers of Krepto core code.
...
- For `strprintf`, `LogInfo`, `LogDebug`, etc formatting characters don't need size specifiers.
  ...
  - *Rationale*: Krepto core uses tinyformat, which is type safe. Leave them out to avoid confusion.
...
Some of these are maintained by active developers of Krepto core, in which case
...
a Krepto core subtree, so that they can be integrated quickly. Cosmetic changes
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Krepto core, the wallet was always
