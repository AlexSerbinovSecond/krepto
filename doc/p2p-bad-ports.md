When Krepto core automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by Krepto core,
...
Below is a list of "bad" ports which Krepto core avoids when choosing a peer to
