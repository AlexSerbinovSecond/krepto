# PSBT Howto for Krepto core

Since Krepto core 0.17, an RPC interface exists for Partially Signed Bitcoin
...
#### Multisig with multiple Krepto core instances
...
Krepto core. We assume their wallets only contain the multisig funds. In case
