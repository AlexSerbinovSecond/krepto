Krepto core version 0.13.1 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of Krepto core
...
- **More efficient almost-full-node security** Katoshi Nakamoto's original
  ...
  note that Krepto core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Bitcoin users to individually opt-in to almost any change in the Bitcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Krepto core contributors that may use this
...
Since Krepto core 0.10.0, nodes have defaulted to only relaying and
