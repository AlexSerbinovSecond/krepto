Krepto core version 0.14.0 is now available from:
...
Krepto core is extensively tested on multiple operating systems using
...
Krepto core has supported automatically pruning the blockchain since 0.11. Pruning
...
When Krepto core is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in Krepto core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Krepto core. This was added in conjunction with
...
- incremental relay fee used for calculating BIP 125 replacement and mempool limiting. (1000 katoshis/kB)
- calculation of threshold for a dust output. (effectively 3 * 1000 katoshis/kB)
- minimum fee rate of a package of transactions to be included in a block created by the mining code. If miners wish to set this minimum they can use the new `-blockmintxfee` option.  (defaults to 1000 katoshis/kB)
