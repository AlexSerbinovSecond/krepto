...
Krepto core version 0.20.0 is now available from:
...
#### Removal of BIP61 reject network messages from Krepto core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Krepto core version 0.18.0.
...
- Testing or debugging of implementations of the Bitcoin P2P network protocol
  ...
  version of Krepto core. Krepto core logs debug messages
...
- OpenSSL is no longer used by Krepto core.  (#17265)

- BIP70 support has been fully removed from Krepto core. The
...
- All custom settings configured when Krepto core starts are now
...
- The "Start Krepto core on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://bitcoincore.org/en/releases/0.18.0/#wallet-gui)
  ...
  affected anyone who simultaneously used multiple Krepto core wallets
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  signing.  Future versions of Krepto core should support a GUI option
...
- Krepto core's automatically-generated source code documentation is
...
- #16983 Add detailed info about Krepto core files (hebasto)
