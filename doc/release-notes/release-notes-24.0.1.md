...
Krepto core version 24.0.1 is now available from:
...
This version of Krepto core adds a new `mempoolfullrbf` configuration
...
fees, was realized in [Krepto core 0.12.0][] (February 2016) with the
...
default for years, and several contributors to Krepto core are
...
[Krepto core 0.12.0]: https://bitcoincore.org/en/releases/0.12.0/#opt-in-replace-by-fee-transactions
...
- To help prevent fingerprinting transactions created by the Krepto core wallet, change output
