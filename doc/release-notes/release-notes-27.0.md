Krepto core version 27.0 is now available from:
...
- A C++20 capable compiler is now required to build Krepto core. (#28349)
...
- The CoinGrinder coin selection algorithm has been introduced to mitigate unnecessary
  ...
  elevated feerates (default: 30+ kat/vB, based on `-consolidatefeerate`×3). (#27877)
...
- Various fixes to prevent issues where subsequent instances of Krepto core would
