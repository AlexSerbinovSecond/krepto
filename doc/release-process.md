...
Checkout the Krepto core version you'd like to build:
...
- Announce the release:
  ...
  - Krepto core announcements list https://bitcoincore.org/en/list/announcements/join/

  - Krepto core Twitter https://twitter.com/bitcoincoreorg
