 ...
 */
const std::string CLIENT_NAME("Katoshi");
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Krepto core copyright is not removed by accident
    if (copyright_devs.find("Krepto core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Krepto core developers";
    }
