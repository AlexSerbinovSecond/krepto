...
static const CAmount DEFAULT_CONSOLIDATE_FEERATE{10000}; // 10 kat/vbyte
/**
...
//! Discourage users to set fees higher than this amount (in katoshis) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in katoshis)
...
public:
    ...
    /** Absolute maximum transaction fee (in katoshis) used by default for the wallet */
