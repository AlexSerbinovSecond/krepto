...
class MempoolLimitTest(BitcoinTestFramework):
    ...
    def test_mid_package_eviction(self):
        ...
        # Specific number of katoshis to fit within a small window. The parent_cpfp + child package needs to be
        ...
        magic_katoshis = 1200
        cpfp_katoshis = int(cpfp_fee * COIN) + magic_katoshis

        child = self.wallet.create_self_transfer_multi(utxos_to_spend=parent_utxos, fee_per_output=cpfp_katoshis)
