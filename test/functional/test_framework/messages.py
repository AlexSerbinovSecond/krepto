...
# Copyright (c) 2010-2022 The Krepto core developers
...
COIN = 100000000  # 1 btc in katoshis
...
class CBlockLocator:
    ...
    def serialize(self):
        r = b""
        r += (0).to_bytes(4, "little", signed=True)  # Krepto core ignores the version field. Set it to 0.
