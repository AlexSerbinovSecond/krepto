...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test sendmany with fee_rate param (explicit fee rate in kat/vB)")
        fee_rate_sat_vb = 2
        ...
        assert_raises_rpc_error(-6, "Fee rate (0.999 kat/vB) is lower than the minimum fee rate setting (1.000 kat/vB)",
        ...
        if not self.options.descriptors:
            ...
            self.log.info("Test sendtoaddress with fee_rate param (explicit fee rate in kat/vB)")
