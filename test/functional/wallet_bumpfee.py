#!/usr/bin/env python3
# Copyright (c) 2016-2022 The Krepto core developers
...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 btc (100,000 katoshis)
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "kat/B", "BTC/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Bump with fee_rate of 350.25 kat/vB vbytes to create dust.
