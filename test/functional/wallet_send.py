#!/usr/bin/env python3
# Copyright (c) 2020-2022 The Krepto core developers
...
class WalletSendTest(BitcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        getcontext().prec = 8 # Katoshi precision for Decimal
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-8, "Use fee_rate (kat/vB) instead of feeRate", w0.send, {w1.getnewaddress(): 1}, 6, "conservative", 1, {"feeRate": 0.01})
        ...
        for target, mode in product([-1, 0], ["btc/kb", "kat/b"]):
        ...
        # Test setting explicit fee rate just below the minimum of 1 kat/vB.
        self.log.info("Explicit fee rate raises RPC error 'fee rate too low' if fee_rate of 0.99999999 is passed")
        msg = "Fee rate (0.999 kat/vB) is lower than the minimum fee rate setting (1.000 kat/vB)"
        ...
        msg = "Fee rate (0.000 kat/vB) is lower than the minimum fee rate setting (1.000 kat/vB)"
        ...
        # Test fee_rate values that cannot be represented in kat/vB.
        ...
        # res = self.test_send(from_wallet=w0, to_wallet=w1, amount=1, conf_target=0.1, estimate_mode="kat/b", add_to_wallet=False)
        # assert res["hex"]
        # hex = res["hex"]
